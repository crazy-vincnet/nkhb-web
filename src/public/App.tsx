    ...
    return (
        <HelmetProvider>
            <Router>
                ...
                {/*
                 * ⚡ Bolt Optimization:
                 * Render the isolated, memoized Modals component here.
                 * This removes modal state management from App.tsx, preventing
                 * full app re-renders when a modal is toggled.
                 */}
                <Modals />
            </Router>
        </HelmetProvider>
