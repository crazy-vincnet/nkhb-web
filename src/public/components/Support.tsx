                ...
                <section className="section support" id="support" style={sectionStyles}>
                    <div className="container">
                        <div className="section-header">
                            ...
                            <Editable k="support_desc" headless>
                        ...
                        <div className="participation-sub-section" id="support-sub">
                            <Editable k="support_appeal_desc" headless>
                        ...
                        <div className="impact-info-container">
                            <div className="impact-box">
                                <Editable k="support_impact1_title" headless>
                            ...
                            <div className="impact-box">
                                <Editable k="support_impact2_title" headless>
                                    {({ text, styles }) => <h3 style={styles} dangerouslySetInnerHTML={{ __html: text }}></h3>}
                                </Editable>
                                <ul>
                        ...
                        <div className="support-boxes-container">
                            <div className="production-support">
                                <Editable k="support_regular_title" headless>
                                    {({ text, styles }) => <h3 style={styles} dangerouslySetInnerHTML={{ __html: text }}></h3>}
                                </Editable>
                            ...
                            <div className="production-support">
                                <Editable k="support_production_title" headless>
                                    {({ text, styles }) => <h3 style={styles} dangerouslySetInnerHTML={{ __html: text }}></h3>}
                                </Editable>
                        ...
                        <div className="account-card">
                            <div className="account-header">
                                ...
                                <Editable k="support_account_title" headless>
                                    {({ text, styles }) => <span style={styles} dangerouslySetInnerHTML={{ __html: text }}></span>}
                                </Editable>
                            </div>
