...
// ⚡ Bolt: Extracting modal state from App.tsx into a dedicated, isolated Modals component
// prevents full-page re-renders whenever a modal is toggled via window.postMessage.
