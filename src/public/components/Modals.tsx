...
// Extracted modal state out of App.tsx into this isolated Modals component.
// This prevents full-page re-renders (Header, Routes, Footer) when a modal opens/closes.
// Wrapped in React.memo so it only re-renders when its own internal state changes.
const Modals = memo(() => {
