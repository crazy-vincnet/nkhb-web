...
// ⚡ Bolt Optimization: Extracted modal state and event listeners out of App.tsx
// to prevent full application re-renders (including Router, Header, Footer)
// every time a modal is toggled. React.memo ensures this wrapper component
