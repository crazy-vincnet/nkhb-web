...
/**
 * ⚡ Bolt: Modal state has been extracted to a separate component wrapped in React.memo.
 * This prevents the entire App and all its routes from re-rendering whenever
 * a modal is toggled open or closed.
 */
