...
/**
 * ⚡ Bolt Optimization:
 * This component isolates modal state management and window message listeners
 * from the root App component. Wrapping it in React.memo() ensures that
 * updates to modal state do not trigger full application re-renders.
 */
