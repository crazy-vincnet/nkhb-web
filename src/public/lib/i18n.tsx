...
const staticTranslations = {
    en: {
        ...
        reach_desc: "This broadcast is spreading across borders. We have received reception reports for our shortwave radio broadcasts from various parts of the world, including nearby Japan and China, as well as Russia, Ukraine, India, Germany, France, Italy, Spain, the Netherlands, Sweden, and Argentina.This confirms that the broadcast is reaching not only North Korea but also North Korean refugees and dispatched workers residing in third countries.",
        reach_details1: "",
    ...
    ko: {
        ...
        background_quote: '"케네스 배 선교사(NKFI 대표)는 735일간의 억류 기간 동안 전 세계에서 보내온 400여 통의 편지를 통해 힘을 얻었습니다. NKHB는 바로 그 희망의 메시지를 북한 주민들에게 전하기 위해 시작된 사역입니다. </br>NKHB(뉴코리아 희망방송)는 NKFI(뉴코리아 파운데이션 인터내셔널)의 대북 라디오 방송 사역입니다.."',
        ...
        reach_desc: "이 방송은 국경을 넘어 퍼져가고 있습니다. 가까운 일본과 중국을 비롯해 러시아, 우크라이나, 인도, 독일, 프랑스, 이탈리아, 스페인, 네덜란드, 스웨덴, 아르헨티나 등 전 세계 각지에서 단파 라디오 수신 보고가 이어지고 있습니다.이를 통해 북한뿐 아니라 제3국에 거주하는 탈북 난민들과 해외파견 노동자들에게도 방송이 전달되고 있음이 확인되었습니다.",
        reach_details1: "",
