...
const Home: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize callbacks to prevent unnecessary re-renders of static section components
    // when global app state (like modal visibility) updates and triggers a re-render.
