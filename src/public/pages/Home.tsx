...
const Home: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize event handlers to prevent child components from re-rendering
    // previously these were inline anonymous functions inside the render loop mapping
        ...
        <>
            ...
            <main>
                {layout.map((key: string) => {
                    ...
                    const props: any = {};
                    // ⚡ Bolt: Use memoized handlers instead of inline functions
