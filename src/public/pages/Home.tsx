...
const Home: React.FC = () => {
    ...
    // Bolt Performance Optimization: Memoizing global event handlers using useCallback.
    // This ensures these functions are not recreated on every render of Home.tsx (e.g., when URL hash changes),
    // which prevents unnecessary full-page re-renders of the static child section components wrapped in React.memo.
