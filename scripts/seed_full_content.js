...
async function seedAllContent() {
  console.log('Seeding all website content into Supabase...');
  ...
  console.log(`Preparing to upsert ${dataToUpsert.length} text and image items...`);

  // Batch upsert to avoid potential limits (though 100+ items is usually fine)
  ...
  if (error) {
    ...
    console.log('💡 Tip: If you get an RLS error, run "ALTER TABLE public.content DISABLE ROW LEVEL SECURITY;" in Supabase SQL Editor first.');
  } else {
    console.log('✅ Successfully seeded all content items.');
  }
}
