...
- **Admin Panel:** `admin/index.html` -> `src/admin/main.tsx`
...
│       ├── pages/    # Letters, Audio, Schedule, Content 등
│       └── App.tsx
...
- **Tables:** `letters`, `audio_tracks`, `schedule`, `content`
- **Security Policy:**
...
- **Tests:** 새로운 기능 추가 시 관련 테스트 코드를 작성하거나, 수동 검증 절차를 문서화합니다.

## 🔗 주요 링크
- **Production URL:** [https://nkhb.org](https://nkhb.org)
- **Admin Path:** `/admin` (로그인 필요)
